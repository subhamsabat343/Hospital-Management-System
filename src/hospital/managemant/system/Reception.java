...
public class Reception extends JFrame{
    ...
    Reception()
    {
        ...
        panel1.add(label);
         ...
         ImageIcon imageicon11=new ImageIcon(ClassLoader.getSystemResource("icon/amb.png"));
        Image i11=imageicon11.getImage().getScaledInstance(300,100,Image.SCALE_DEFAULT);
        ImageIcon imageIcon21=new ImageIcon(i11);
        JLabel label1=new JLabel(imageIcon21);
