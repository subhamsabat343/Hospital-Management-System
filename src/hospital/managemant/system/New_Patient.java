...
public class New_Patient extends JFrame implements ActionListener{
    ...
    JComboBox comboBox;
    JTextField textFieldnumber,textName,textFeildDisease,textFeildDeposite;
    JRadioButton r1,r2;
    Choice c1;
    JLabel date;
    JButton b1,b2;
    ...
    New_Patient()
    {
        ...
        comboBox=new JComboBox<String>(new String[] {"AAdhar Card","Voter ID","Driving Licesence"} );
        comboBox.setBounds(271,73,150,20);
        //comboBox.setBackground(new Color(3,45,48));
        comboBox.setBackground(new Color(255,45,48));
        ...
        textFeildDeposite.setBounds(271,359,150,20);
